...
- For a large feature or architectural change, prefer a short implementation doc placed directly in `infra/docs/project/` before coding.
...
- Place implementation docs directly in `infra/docs/project/`.
