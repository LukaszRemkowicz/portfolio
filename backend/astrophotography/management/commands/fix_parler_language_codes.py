...
from astrophotography.models import AstroImage, Place, MainPageLocation
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write("Starting migration of translation language codes from 'en-us' to 'en'...")
        ...
        for model, name in models_to_check:
            ...
            # However, for batch updates, it's more efficient to query the translation model directly.
            translation_model = model._parler_meta.root_model
            
            count = translation_model.objects.filter(language_code='en-us').update(language_code='en')
