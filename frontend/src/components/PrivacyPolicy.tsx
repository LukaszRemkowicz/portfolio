  ...
  return (
    <>
      <SEO
        ...
        description={t('privacy.introduction.body')}
      />
        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>
                <strong>
                  {t('privacy.dataCollected.items.referral.label')}
                </strong>{' '}
          ...
          <section className={styles.section}>
            ...
            <ol>
              <li>
                <strong>
                  {t('privacy.rights.items.cookieSettings.label')}
                </strong>{' '}
                {t('privacy.rights.items.cookieSettings.value')}
              </li>
              <li>
                <strong>
                  {t('privacy.rights.items.browserSettings.label')}
                </strong>{' '}
