  ...
  useTranslation: () => ({
    t: (key: string) => {
      ...
      const translations: Record<string, string> = {
        ...
        'shop.collectionsLabel': 'Collections',
        'shop.collectionsTitle':
          'A storefront structure ready for real inventory.',
        'shop.catalogLabel': 'Featured mockups',
        'shop.catalogTitle': 'Placeholder products for layout and pacing.',
        'shop.catalogHint':
          'Every card below is intentionally static for now, so we can shape the experience before wiring in a cart or backend inventory.',
        'shop.placeholderBadge': 'Placeholder',
        'shop.placeholderAction': 'Coming soon',
        'shop.panel.eyebrow': 'Launch notes',
        'shop.panel.title': 'Prepared for limited releases.',
        'shop.panel.body':
          'Use this area later for shipping windows, edition sizes, framing notes, or a compact availability summary.',
        'shop.panel.statOneValue': '3',
        'shop.panel.statOneLabel': 'starter collections',
        'shop.panel.statTwoValue': 'Static',
        'shop.panel.statTwoLabel': 'content only',
        'shop.collections.deepSky.name': 'Deep sky editions',
        'shop.collections.deepSky.description':
          'Large-format museum prints for nebulae, galaxies, and long-integration signal-rich compositions.',
        'shop.collections.deepSky.badge': 'Fine art',
        'shop.collections.landscape.name': 'Nightscape panoramas',
        'shop.collections.landscape.description':
          'Wide scenic works that blend terrain, weather, and celestial structure into statement pieces for larger walls.',
        'shop.collections.landscape.badge': 'Canvas-ready',
        'shop.collections.education.name': 'Field guides and study sets',
        'shop.collections.education.description':
          'Smaller educational formats, annotated references, and future workshop bundles built around the same imagery.',
        'shop.collections.education.badge': 'Learning',
        'shop.products.orion.name': 'Orion Nebula study',
        'shop.products.orion.format': 'Archival print',
        'shop.products.orion.price': 'from $95',
        'shop.products.orion.description':
          'Placeholder copy for a hero deep-sky release with edition notes, paper options, and signed variant details.',
        'shop.products.alps.name': 'Galactic ridge panorama',
        'shop.products.alps.format': 'Canvas mockup',
        'shop.products.alps.price': 'from $140',
        'shop.products.alps.description':
          'Placeholder copy for a panoramic landscape product with room for framing and size-selection controls.',
        'shop.products.guide.name': 'Beginner sky atlas set',
        'shop.products.guide.format': 'Companion booklet',
        'shop.products.guide.price': 'from $32',
        'shop.products.guide.description':
          'Placeholder copy for a future educational item, such as a printed guide or bundled observing notes.',
